...
async function POST(request) {
    try {
        ...
        try {
            const [existing] = await connection.execute(`SELECT id FROM admin_accounts WHERE phone = ? OR email = ? LIMIT 1`, [
                phone,
                email
            ]);
            ...
            const [result] = await connection.execute(`INSERT INTO admin_accounts (name, phone, email, password_hash, admin_tier, status)
         VALUES (?, ?, ?, ?, ?, 'active')`, [
                name,
                phone,
                email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__283e1ef0._.js.map