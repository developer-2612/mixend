...
export async function getAllUsers(adminId = null) {
...
export async function getAllMessages(adminId = null) {
  const connection = await getConnection();
  try {
    const params = [];
    let whereClause = '';
...
export async function getMessagesForUser(userId, adminId = null) {
  const connection = await getConnection();
  try {
    const params = [userId];
...
export async function getAllRequirements(adminId = null) {
  const connection = await getConnection();
  try {
    const params = [];
    let whereClause = '';
...
export async function getAllNeeds(adminId = null) {
  const connection = await getConnection();
  try {
    const params = [];
    let whereClause = '';
...
export async function getAllBroadcasts(adminId = null) {
  const connection = await getConnection();
  try {
    const params = [];
    let whereClause = '';
...
export async function getAllTemplates(adminId = null) {
  const connection = await getConnection();
  try {
    const params = [];
    let whereClause = '';
